...
import com.example.driverbooking.Common.DRIVER_INFO_REFERENCE
...
class SplashScreenActivity : AppCompatActivity() {
    ...
    companion object {
        private val LOGIN_REQUEST_CODE = 7000
    }
    ...
    private fun showRegisterLayout() {
        ...
        btn_continue.setOnClickListener{
            ...
            else if(TextUtils.isDigitsOnly(edt_first_name.text.toString()))
            {
    ...
    private fun showLoginLayout() {
        val authMethodPickerLayout = AuthMethodPickerLayout.Builder(R.layout.layout_sign_in)
            ...
            .setEmailButtonId(R.id.btn_google_sign_in)
            .build();
